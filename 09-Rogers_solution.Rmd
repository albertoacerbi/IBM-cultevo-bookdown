...
The following function modifies the rogers_model function from the last chapter to include critical learners. We need to change the code in a few places, as explained below the chunk. 
...
```{r 9.4, fig.cap="The average fitness of critical learners (black line) clearly exceeds the average fitness of populations entirely comprised of individual learners."}
