...
```{r 8.10, fig.cap="On average the proportion of social learners fluctuates around $0.5$ (black line). However, individual runs have a larger spread around this mean (overlapping runs in in grey)."}
...
```{r 8.11, fig.cap="Populations with roughly 50% social learners have on average the same fitness (black line) as populations with only individual learners (dashed line). Even though populations with social learners sometimes exceed the average fitness of all-individual learner populations they also sometimes fall far below it (shaded area)."}
...
```{r 8.13, fig.cap="When individual learning is accurate, there will be more social learners in populations (top), and average fitness of mixed populations (bottom, black line) will more often exceed that of purely individual learner populations."}
...
```{r 8.14, fig.cap="When the environment is unchanging, social learners will outperform individual learners and take over in populations (top), as their average fitness (bottom, black line) is much higher than that of indiviudal learners (dashed line)."}
