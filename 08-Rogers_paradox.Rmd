...
produce_IL <- sample(c(TRUE, FALSE), N, 
                     prob = c(fitness_IL, 1 - fitness_IL), 
                     replace = TRUE)
      
# Also add mutation, chance of switching learning types
mutation <- sample(c(TRUE, FALSE), N, prob = c(mu, 1 - mu), replace = TRUE)
      
# If parent is an individual learner and no mutation, then they're an individual learner
...
population$learning[produce_IL & mutation] <- "social"  
# If parent is a social learner plus mutation, then they're an individual learner
population$learning[!produce_IL & mutation] <- "individual"  
```
