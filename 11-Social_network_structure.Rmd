...
```{r 11.3.1, echo=FALSE, fig.cap="Different graph types (from left: circle, lattice, random, scale free, fully connected) vary in the density and distribution of edges between nodes."}
library(igraph)
parbefore <- par()$mar
par(mar=c(0,0,0,0))
par(mfrow=c(1,5))
