...
Now, we can say that with increasing degree centrality information (or gossip) does not only spread to larger proportions of a population but it does so faster. This is true for the random network the we have tested here. With the next model we will take a closer look at clustered networks. 
